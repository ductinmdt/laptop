                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="home.php">
                                <img src="./images/banner/logo_ankhang.png" alt="home.php">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="footer-newsletter">
                            ...
                            <div class="newsletter-form-head">
                                <form action="#" method="get" target="_blank" class="newsletter-form">
                                    ...
                                    <div class="button">
                                        <button class="btn">Gửi<span class="dir-part"></span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6">
                        ...
                        <div class="single-footer f-contact">
                            ...
                            <ul>
                                <li><span>Thứ hai - thứ Sáu </span> 9 giờ sáng - 8 giờ tối</li>
                                <li><span>Thứ bảy: </span> 10 giờ sáng - 6 giờ chiều</li>
                            </ul>
                            <p class="mail">
                                <a href="mailto:ductinmdt@gmail.com">ductinmdt@gmail.com</a>
                            </p>
                        </div>
                        <!-- End Single Widget -->
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-12">
                        <div class="payment-gateway">
                            ...
                            <img src="images/banner/credit-cards-footer.png" alt="#">
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
                            <p>Được thiết kế và phát triển bởi<a href="#" rel="nofollow" target="_blank" style="text-decoration: none;">©DucTin</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">

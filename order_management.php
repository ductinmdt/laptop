									...
									while ($data_user = mysqli_fetch_assoc($result)) {
										...
										echo '
												<tr>
													...
													<th >';
										if ($process == '0') {
											echo '<a onclick="return ConfirmProcess();" href="process.php?id=' . $id_trans . '" >
															<input type="button" name="process" class="btn btn-success" value="Xử lý đơn hàng"/>
														</a>
														<a onclick="return ConfirmProcess();" href="cancel.php?id=' . $id_trans . '" >
															<input type="button" class="btn btn-danger" name="process" value="Hủy đơn"/>
														</a>';
										}
										elseif ($process == '1'){
											echo '<a class="text-success">Hoàn tất</a>';
										}
										else{
											echo '<a class="text-danger">Đã hủy</a>';
										}
